  ...
  public async processMessage(body: any): Promise<any> {
    ...
    try {
      ...
      if (
        ...
        (userData.user_context === null || text.body === 'hi')) 
        {
        ...
        console.log("Sure message is true")
        await this.userService.updateUserContext(
          from,
          this.botId,
          english.context[0],
        );
        await this.message.sendSureMessage(from, userData.language);
      } else if (
        ...
        if (userData.question_limit <= 10) {
          ...
          const question =
            (dataresponse && dataresponse[0] && dataresponse[0].question) ||
            body.text.body;
